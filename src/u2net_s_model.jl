function U2NetP(in_ch=3, out_ch=1)
    stage1 = rsu7(in_ch, 16, 64)
    ...
    side3 = Conv((3, 3), 64 => out_ch; pad=1)
    side4 = Conv((3, 3), 64 => out_ch; pad=1)
    side5 = Conv((3, 3), 64 => out_ch; pad=1)
    side6 = Conv((3, 3), 64 => out_ch; pad=1)
